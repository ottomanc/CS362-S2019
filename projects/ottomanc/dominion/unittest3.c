/*
 * unittest3.c
 * Positive test case for Council Room
...
int main() {
	...
	// ----------- TEST 1: add 4 cards to hand from their own deck--------------
	printf("TEST 1: add 4 cards to current player hand\n");
	...
	printf("TEST 2: add one buy to the current player\n");
    ...
    // ----------- TEST 3:  Other Players should get 1 card from their deck --------------
	printf("TEST 3: Other players draw one card form their pile\n");
